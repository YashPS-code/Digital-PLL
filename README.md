...
Phase Detection: XOR(fref, ffeedback) produces pulses proportional to phase error Δφ. Average duty cycle ~ Δφ/180°.</br>
...
<h3>Limitations</h3>
XOR PD limited to 0-90° error range; use for narrowband apps.</br>
